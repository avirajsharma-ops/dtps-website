  ...
  const features = [
    {
      ...
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
          <rect x="6" y="4" width="16" height="20" rx="2" stroke="#0d9488" strokeWidth="2" />
          <line x1="10" y1="9" x2="18" y2="9" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" />
          <line x1="10" y1="13" x2="18" y2="13" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" />
          <line x1="10" y1="17" x2="14" y2="17" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
          <path d="M6 10H22M6 14H22M10 18H18" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
          <rect x="6" y="6" width="16" height="16" rx="2" stroke="#0d9488" strokeWidth="2" />
          <path d="M10 12H18M10 16H14" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" />
          <path d="M18 10V6M10 10V6" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
    },
  ];
