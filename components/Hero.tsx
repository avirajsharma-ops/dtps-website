    ...
    <section className="hero-wrapper">
      <div className="hero">
        ...
        <div className="hero-container-mobile flex flex-col md:hidden">
          {/* Mobile Image Section - Poonam Sagar image FIRST */}
          <div className="hero-image-mobile relative flex justify-center items-center pt-6 pb-4">
            <div className="relative">
              ...
              <div className="absolute right-0 bottom-[40px] bg-[#ff9100] py-2 px-3 rounded-[10px] flex items-center gap-1.5 z-[4] shadow-[0_10px_30px_rgba(245,124,0,0.3)]">
                ...
                <span className="text-[0.6rem] text-white leading-[1.2] font-medium">Years of<br />experience</span>
              </div>
            </div>
          </div>

          {/* Mobile Content Section - Text SECOND */}
          <div className="hero-content-mobile relative z-[2] px-5 text-center pt-4 pb-8">
            ...
            <div className="flex flex-row items-center justify-center gap-4">
              <Link href="#programs" className="btn btn-primary text-sm py-3 px-6">Know More</Link>
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 bg-white/10 border border-white/20 rounded-full flex items-center justify-center text-base">📞</div>
        ...
        <div className="hero-container hidden md:grid md:grid-cols-2 md:items-center">
          ...
          <div className="hero-content relative z-[2] pl-5 text-left self-center">
            ...
            <h1 className="hero-title text-[3.2rem] font-bold text-white leading-[1.2] mb-5">
              Transform your health<br />
              embrace life today!
            </h1>
            ...
            <div className="hero-actions flex flex-row items-center justify-start gap-5 mb-10">
              <Link href="#programs" className="btn btn-primary text-base py-3.5 px-8">Know More</Link>
              <div className="hero-phone flex items-center gap-3">
                <div className="phone-icon w-12 h-12 bg-white/10 border border-white/20 rounded-full flex items-center justify-center text-xl">📞</div>
                <div className="phone-info flex flex-col">
                  <span className="phone-label text-white/60 text-[0.8rem]">Call Us 24/7</span>
                  <span className="phone-number text-white font-bold text-[1.05rem]">9893027688</span>
                </div>
              </div>
            </div>
            <div className="hero-reviews flex items-center gap-3 justify-start">
              <div className="review-avatars flex items-center">
                <Image 
                  ...
                  width={36} 
                  height={36}
                  className="w-9 h-9 rounded-full border-2 border-[#0d4043] object-cover"
                />
                <Image 
                  ...
                  width={36} 
                  height={36}
                  className="w-9 h-9 rounded-full border-2 border-[#0d4043] -ml-2.5 object-cover"
                />
                <Image 
                  ...
                  className="w-9 h-9 rounded-full border-2 border-[#0d4043] -ml-2.5 object-cover"
                />
                <span className="review-count w-9 h-9 bg-[#0d9488] rounded-full flex items-center justify-center text-white text-[0.7rem] font-bold -ml-2.5">15K</span>
              </div>
